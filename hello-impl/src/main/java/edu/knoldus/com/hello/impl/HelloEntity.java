...
import akka.Done;
import edu.knoldus.com.hello.impl.HelloCommand.Hello;
import edu.knoldus.com.hello.impl.HelloCommand.UseGreetingMessage;
import edu.knoldus.com.hello.impl.HelloEvent.GreetingMessageChanged;
...
public class HelloEntity extends PersistentEntity<HelloCommand, HelloEvent, HelloState> {
  ...
  public Behavior initialBehavior(Optional<HelloState> snapshotState) {
    ...
    BehaviorBuilder b = newBehaviorBuilder(
        snapshotState.orElse(new HelloState("HelloIFoundYou", LocalDateTime.now().toString())));
